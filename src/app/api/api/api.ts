...
export * from './lectureInstancesController.service';
import { LectureInstancesControllerService } from './lectureInstancesController.service';
...
export const APIS = [AccountControllerService, AuthenticationControllerService, CourseControllerService, CourseInstanceControllerService, DocumentControllerService, EnrollmentControllerService, ExamPeriodControllerService, LectureInstancesControllerService, LecturerControllerService, ProfileControllerService, StudentControllerService, TestControllerService];
