...
export const APIS = [AccountService, CourseService, CourseInstanceService, EnrollmentService, LecturerControllerService, PetService, ProfileControllerService, StudentControllerService, UserService];
